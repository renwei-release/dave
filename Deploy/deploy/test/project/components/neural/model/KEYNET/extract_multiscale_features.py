...
# --------------------------------------------------------------------------------
# 2021.07.08.
# 来自KeyNet内的extract_multiscale_features.py文件，需要做出少许修改才能满足API调用
# 需求
# ================================================================================
#
import os, sys, cv2
...
import argparse
import KEYNET.KeyNet.keyNet.keynet_aux.tools as aux
from skimage.transform import pyramid_gaussian
import KEYNET.KeyNet.HSequences_bench.tools.geometry_tools as geo_tools
import KEYNET.KeyNet.HSequences_bench.tools.repeatability_tools as rep_tools
from KEYNET.KeyNet.keyNet.model.keynet_architecture import *
import KEYNET.KeyNet.keyNet.keynet_aux.desc_aux_function as loss_desc
from KEYNET.KeyNet.keyNet.model.hardnet_pytorch import *
from KEYNET.KeyNet.keyNet.datasets.dataset_utils import read_bw_image
import torch
...
def extract_multiscale_features(model, checkpoint_det_dir, image_data):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            im_pts, descriptors = extract_features(image_data)
