...
vgg16_pretrained_model = '/project/model/trained_model/cuda10-caojinglei-docker/Sculptures_train_tfrecords/vgg16.npy'
data_dict = np.load(vgg16_pretrained_model, encoding='latin1').item()
