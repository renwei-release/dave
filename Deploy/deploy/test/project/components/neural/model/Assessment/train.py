...
from assessment.dataset.dataset import AVADataset

from assessment.model.model import *
...
def main(config):
    ...
    base_model.load_state_dict(torch.load('/project/model/pretrained_model/VGG/vgg16-397923af.pth'))
    # print(base_model,'======================================')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dense_lr', type=float, default=5e-3)
