...
void * base_thread_co_id_msg(ThreadId src_id, ThreadId dst_id, ub req_id, ub req_len, u8 *req_body, ub rsp_id, s8 *fun, ub line);
...
void * base_thread_co_name_msg(ThreadId src_id, s8 *dst_thread, ub req_id, ub req_len, u8 *req_body, ub rsp_id, s8 *fun, ub line);
...
void * base_thread_co_gid_msg(ThreadId src_id, s8 *gid, s8 *dst_thread, ub req_id, ub req_len, u8 *req_body, ub rsp_id, s8 *fun, ub line);
