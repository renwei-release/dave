...
s8 *
t_auto_SIPSignalType_str(SIPSignalType enum_value)
{
	s8 *value_str = _string_buf;

	switch(enum_value)
	{
		case SIPSignalType_server:
				value_str = "'SIPSignalType_server'";
			break;
		case SIPSignalType_client:
				value_str = "'SIPSignalType_client'";
			break;
		case SIPSignalType_max:
				value_str = "'SIPSignalType_max-0x1fffffffffffffff'";
			break;
		default:
				dave_snprintf(_string_buf, sizeof(_string_buf), "'%d'", enum_value);
			break;
