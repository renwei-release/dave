...
static void DESKey PROTO_LIST ((UINT4 subkeys[32], unsigned char key[8], int encrypt));   
 ...
 */   
void DESX_CBCInit (DESX_CBC_CTX *context, unsigned char key[24], unsigned char iv[8], int encrypt)
{     
  /* Copy encrypt flag to context.  
   */   
  context->encrypt = encrypt;   
...
static void DESKey (UINT4 subkeys[32], unsigned char key[8], int encrypt)
{   
  UINT4 kn[32];   
  int i, j, l, m, n;   
