...
s8 *
dave_json_c_version(void)
{
	return (s8 *)json_c_version();
}

void *
__dave_string_to_json_c__(s8 *string_data, sb string_length, s8 *fun, ub line)
{
...
s8 *
dave_json_c_to_string(void *object, ub *length)
{
	const char *string;
...
void *
dave_json_c_malloc(void)
{
	return (void *)json_object_new_object();
}

void
dave_json_c_free(void *object)
{
	if(object != NULL)
	{
...
void *
dave_json_c_array_malloc(void)
{
	return (void *)json_object_new_array();
}

dave_bool
dave_json_c_add_object(void *object, char *key, void *obj)
{
...
void
dave_json_c_del_object(void *object, char *key)
{
...
void *
dave_json_c_get_object(void *object, char *key)
{
...
dave_bool
dave_json_c_add_array(void *object, char *key, void *array)
{
	if(object == NULL)
	{
		return dave_false;
...
void *
dave_json_c_get_array(void *object, char *key)
{
...
dave_bool
dave_array_add_json_c(void *array, void *object)
{
...
dave_bool
dave_json_c_add_ub(void *object, char *key, ub ub_data)
{
	if(object == NULL)
	{
		return dave_false;
...
dave_bool
__dave_json_c_get_ub__(void *object, char *key, ub *ub_data, s8 *fun, ub line)
{
...
dave_bool
dave_json_c_add_sb(void *object, char *key, sb sb_data)
{
	if(object == NULL)
	{
		return dave_false;
...
dave_bool
dave_json_c_get_sb(void *object, char *key, sb *sb_data)
{
...
dave_bool
dave_json_c_add_double(void *object, char *key, double double_data)
{
	if(object == NULL)
	{
		return dave_false;
...
dave_bool
__dave_json_c_get_double__(void *object, char *key, double *double_data, s8 *fun, ub line)
{
...
dave_bool
dave_json_c_add_str(void *object, char *key, s8 *str_data)
{
...
dave_bool
dave_json_c_add_str_len(void *object, char *key, s8 *str_data, ub str_len)
{
	if((object == NULL) || (key == NULL) || (str_data == NULL))
	{
		PARTYABNOR("some ptr is NULL:%lx,%lx,%lx", object, key, str_data);
...
dave_bool
__dave_json_c_get_str__(void *object, char *key, s8 *str_data, ub *str_length, s8 *fun, ub line)
{
...
ub
__dave_json_c_get_str_v2__(void *object, char *key, s8 *str_data, ub str_length, s8 *fun, ub line)
{
	if(__dave_json_c_get_str__(object, key, str_data, &str_length, fun, line) == dave_false)
	{
		return 0;
	}
...
dave_json_c_get_array_length(void *array)
{
	...
	{
		if(json_object_get_type(object_object) != json_type_array)
			return 0;
...
void *
dave_json_c_get_array_idx(void *array, sb index)
{
	struct json_object *object_object;
...
dave_bool
dave_json_c_add_boolean(void *object, char *key, dave_bool bool_data)
{
	if(object == NULL)
	{
		return dave_false;
...
dave_bool
dave_json_c_get_boolean(void *object, char *key, dave_bool *bool_data)
{
	struct json_object *ub_object;
...
dave_bool
dave_json_c_array_add_str(void *array, s8 *str_data)
{
...
dave_bool
dave_json_c_array_add_str_len(void *array, s8 *str_data, ub str_len)
{
	struct json_object *pObject;
...
s8 *
dave_json_c_array_get_str(void *array, sb index, ub *string_len)
{
	struct json_object *pObject;
...
dave_bool
dave_json_c_array_add_sb(void *array, sb ub_data)
{
	struct json_object *pObject;
...
sb
dave_json_c_array_get_sb(void *array, sb index)
{
	struct json_object *pObject;
...
dave_bool
dave_json_c_array_add_double(void *array, double double_data)
{
	struct json_object *pObject;
...
double
dave_json_c_array_get_double(void *array, sb index)
{
	struct json_object *pObject;
...
dave_bool
dave_json_c_array_add_int(void *array, ub int_data)
{
	struct json_object *pObject;
...
void *
dave_json_c_array_get_object(void *array, sb index)
{
	return dave_json_get_array_idx(array, index);
}

dave_bool
__dave_json_c_array_add_object__(void *array, void *pObject, s8 *fun, ub line)
{
	if(pObject != NULL)
	{
		json_object_array_add((struct json_object *)array, pObject);
...
dave_bool 
__dave_json_c_array_del_object__(void *array, ub index, s8 *fun, ub line)
{
    if (NULL != array)
    {
...
dave_bool
dave_json_c_array_add_array(void *array_dst, void *array_src)
{
...
dave_bool
dave_json_c_bool_copy(void *pDstJson, void *pSrcJson, char *key)
{
	dave_bool bool_data;
	dave_bool ret;
...
dave_bool
dave_json_c_ub_copy(void *pDstJson, void *pSrcJson, char *key)
{
	ub ub_data;
	dave_bool ret;
...
dave_bool
dave_json_c_str_copy(void *pDstJson, void *pSrcJson, char *key)
{
	s8 *str_data;
	ub str_length = 2048;
	dave_bool ret;
...
dave_bool
dave_json_c_array_copy(void *pDstJson, void *pSrcJson, char *key)
{
...
dave_bool
dave_json_c_write(void *pJson, s8 *file_name, dave_bool direct_flag)
{
	FileOptFlag flag;
	s8 *json_str;
	size_t json_len;
...
dave_json_c_read(s8 *file_name, dave_bool direct_flag)
{
	...
	data_len = dave_os_file_read(flag, file_name, 0, data_len, data_ptr);
	if(data_len > 0)
	{
		data_ptr[data_len] = '\0';

		pJson = dave_string_to_json(data_ptr, data_len);
	}
