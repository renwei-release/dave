...
#define LWS_INSTALL_DATADIR "/project/DAVE/ThirdParty/build/libwebsockets/setup/share"
#define LWS_INSTALL_LIBDIR "/project/DAVE/ThirdParty/build/libwebsockets/setup/lib"
