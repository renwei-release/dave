...
#ifndef MINISIZE
#ifndef osip_malloc
#define osip_malloc(S) (osip_malloc_func ? osip_malloc_func(S) : dave_malloc(S))
#endif
#ifndef osip_realloc
#define osip_realloc(P, S) (osip_realloc_func ? osip_realloc_func(P, S) : dave_realloc(P, S))
#endif
#ifndef osip_free
#define osip_free(P)       \
  {                        \
