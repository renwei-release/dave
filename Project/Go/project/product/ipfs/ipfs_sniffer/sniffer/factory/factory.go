...
import (
    ...
    "dave/product/ipfs/ipfs_sniffer/sniffer"
    ...
    "net"
    "dave/product/ipfs/ipfs_sniffer/sniffer/proxy"
    "dave/product/ipfs/ipfs_sniffer/snifferNew"
)
...
func Start(ctx context.Context, ds datastore.Batching) (context.Context, datastore.Batching, error) {
    ds = proxy.New(ds, snifferNew.AfterPut)
    //cfg, err := getConfig()
    //if err != nil {
    //    return nil, nil, err
    //}
    ...
    //
    //s, err := getSniffer(sniffer.DefaultConfig(), ds, q, i)
    //if err != nil {
    //    cancel()
    //    return nil, nil, err
    //}
