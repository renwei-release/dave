...
dave_bool base_thread_name_event(s8 *thread_name, ub req_id, ub req_len, u8 *req_body, ub rsp_id, base_thread_fun rsp_fun, s8 *fun, ub line);
dave_bool base_thread_gid_msg(s8 *gid, s8 *thread_name, ub msg_id, ub msg_len, u8 *msg_body, s8 *fun, ub line);
dave_bool base_thread_gid_event(s8 *gid, s8 *thread_name, ub req_id, ub req_len, u8 *req_body, ub rsp_id, base_thread_fun rsp_fun, s8 *fun, ub line);
...
#define name_event(thread_name, req_id, req_body, rsp_id, rsp_fun) base_thread_name_event(thread_name, (ub)req_id, sizeof(*req_body), (u8 *)(req_body), (ub)rsp_id, rsp_fun, (s8 *)__func__, (ub)__LINE__)
...
#define gid_event(gid, thread_name, req_id, req_body, rsp_id, rsp_fun) base_thread_gid_event(gid, thread_name, (ub)req_id, sizeof(*req_body), (u8 *)(req_body), (ub)rsp_id, rsp_fun, (s8 *)__func__, (ub)__LINE__)
