...
void * t_rpc_ver3_zip_BillingRulesPrivate(BillingRulesPrivate *zip_data);
dave_bool t_rpc_ver3_unzip_BillingRulesPrivate(BillingRulesPrivate *unzip_data, void *pStructBson);

void * t_rpc_ver3_zip_BillingRulesPrivate_d(BillingRulesPrivate *zip_data, ub zip_len);
dave_bool t_rpc_ver3_unzip_BillingRulesPrivate_d(BillingRulesPrivate *unzip_data, ub unzip_len, void *pArrayBson);
...
void * t_rpc_ver3_zip_Account(Account *zip_data);
dave_bool t_rpc_ver3_unzip_Account(Account *unzip_data, void *pStructBson);

void * t_rpc_ver3_zip_Account_d(Account *zip_data, ub zip_len);
dave_bool t_rpc_ver3_unzip_Account_d(Account *unzip_data, ub unzip_len, void *pArrayBson);

void * t_rpc_ver3_zip_DeviceInfo(DeviceInfo *zip_data);
dave_bool t_rpc_ver3_unzip_DeviceInfo(DeviceInfo *unzip_data, void *pStructBson);

void * t_rpc_ver3_zip_DeviceInfo_d(DeviceInfo *zip_data, ub zip_len);
dave_bool t_rpc_ver3_unzip_DeviceInfo_d(DeviceInfo *unzip_data, ub unzip_len, void *pArrayBson);
...
void * t_rpc_ver3_zip_BillingUser(BillingUser *zip_data);
dave_bool t_rpc_ver3_unzip_BillingUser(BillingUser *unzip_data, void *pStructBson);

void * t_rpc_ver3_zip_BillingUser_d(BillingUser *zip_data, ub zip_len);
dave_bool t_rpc_ver3_unzip_BillingUser_d(BillingUser *unzip_data, ub unzip_len, void *pArrayBson);
