...
dave_bool base_thread_id_event(ThreadId src_id, ThreadId dst_id, BaseMsgType msg_type, ub req_id, ub msg_len, u8 *msg_body, ub rsp_id, thread_msg_fun rsp_fun, s8 *fun, ub line);
dave_bool base_thread_name_msg(s8 *thread_name, ub msg_id, ub msg_len, u8 *msg_body, s8 *fun, ub line);
dave_bool base_thread_name_event(s8 *thread_name, ub req_id, ub msg_len, u8 *msg_body, ub rsp_id, thread_msg_fun rsp_fun, s8 *fun, ub line);
...
#define write_msg(dst_id, msg_id, msg_body) base_thread_id_msg(INVALID_THREAD_ID, dst_id, BaseMsgType_Unicast, (ub)msg_id, sizeof(*msg_body), (u8 *)(msg_body), 0, (s8 *)__func__, (ub)__LINE__)
#define write_nmsg(dst_id, msg_id, msg_body, msg_number) base_thread_id_msg(INVALID_THREAD_ID, dst_id, BaseMsgType_Unicast, (ub)msg_id, sizeof(*msg_body), (u8 *)(msg_body), msg_number, (s8 *)__func__, (ub)__LINE__)
#define write_event(dst_id, req_id, msg_body, rsp_id, rsp_fun) base_thread_id_event(INVALID_THREAD_ID, dst_id, BaseMsgType_Unicast, (ub)req_id, sizeof(*msg_body), (u8 *)(msg_body), (ub)rsp_id, rsp_fun, (s8 *)__func__, (ub)__LINE__)
