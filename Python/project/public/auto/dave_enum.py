...
CurrencyType_max = CurrencyType_reserve1 + 1
...
__ErrCode_last_xxxx__ = ERRCODE_Can_not_find_isp + 1
ErrCode_last_value = __ErrCode_last_xxxx__-2
...
MCardContentType_end = MCardContentType_refresh_recommend_cache + 1
...
TRACELEVEL_DEBUG = 0
TRACELEVEL_CATCHER = TRACELEVEL_DEBUG + 1
TRACELEVEL_TRACE = TRACELEVEL_CATCHER + 1
TRACELEVEL_LOG = TRACELEVEL_TRACE + 1
TRACELEVEL_ABNORMAL = TRACELEVEL_LOG + 1
TRACELEVEL_ASSERT = TRACELEVEL_ABNORMAL + 1
TRACELEVEL_MAX = TRACELEVEL_ASSERT + 1
