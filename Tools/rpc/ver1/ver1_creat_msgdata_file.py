...
def creat_msgdata_file():
    ...
    print(f"{len(msg_struct_table)}\tmsgdata\t\twrite to {ver1_msgdata_src_file_name}")
    _creat_msgdata_src_file(msg_struct_table, msg_file_list, ver1_msgdata_src_file_name)
    _creat_msgdata_inc_file(msg_struct_table, msg_file_list, ver1_msgdata_inc_file_name)
    return