...
def creat_pythonrpc_file(struct_total, struct_table, msg_struct_table, define_table, msg_id_table, enum_table):
    ...
    _creat_struct_file(struct_table, struct_total, enum_table, rpc_ver3_pystruct_file_name)
    _creat_struct_file(msg_struct_table, struct_total, enum_table, rpc_ver3_pymsgstruct_file_name)
