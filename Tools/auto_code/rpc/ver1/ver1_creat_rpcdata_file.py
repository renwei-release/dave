...
def creat_rpcdata_file():
    ...
    print(f"{len(struct_table)}\trpcdata\t\twrite to {rpc_ver1_rpcdata_src_file_name}")
    _creat_rpcdata_src_file(msg_table, file_list, rpc_ver1_rpcdata_src_file_name)
    _creat_rpcdata_inc_file(file_list, rpc_ver1_rpcdata_inc_file_name)
    return