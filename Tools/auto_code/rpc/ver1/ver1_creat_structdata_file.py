...
def creat_structdata_file():
    ...
    print(f"{len(struct_table)}\tstructdata\twrite to {rpc_ver1_structdata_src_file_name}")
    union_table, union_include = find_union_table()
    _creat_structdata_src_file(struct_table, union_table, head_list, rpc_ver1_structdata_src_file_name)
    _creat_structdata_inc_file(struct_table, head_list, rpc_ver1_structdata_inc_file_name)
    return