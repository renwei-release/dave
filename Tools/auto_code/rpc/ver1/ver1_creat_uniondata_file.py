...
def creat_uniondata_file():
    ...
    meta_table = find_meta_table(rpc_ver1_metadata_src_file_name)
    _creat_uniondata_remove_metadata(meta_table, union_table)
    print(f"{len(union_table)}\tuniondata\twrite to {rpc_ver1_uniondata_src_file_name}")
    _creat_uniondata_src_file(union_table, include_list, rpc_ver1_uniondata_src_file_name)
    _creat_uniondata_inc_file(union_table, include_list, rpc_ver1_uniondata_inc_file_name)
    return