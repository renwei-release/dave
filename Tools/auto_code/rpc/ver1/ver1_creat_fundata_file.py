...
def creat_fundata_file():
    ...
    print(f"{len(fun_table)}\tfundata\t\twrite to {rpc_ver1_fundata_src_file_name}")
    _creat_fundata_src_file(fun_table, include_list, rpc_ver1_fundata_src_file_name)
    _creat_fundata_inc_file(fun_table, include_list, rpc_ver1_fundata_inc_file_name)
    return